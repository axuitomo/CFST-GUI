...
- TCP 平均延迟、丢包率（默认 15%，最高 100%）、追踪状态码、地区码、下载速度阈值过滤
- 地区码识别与结果排序
...
高级参数包括 TCP并发线程、追踪候选上限、单 IP 下载测速时间、下载预热时间、GET 分片并发、下载协议、下载缓冲、端口、文件测速URL、追踪 URL、User-Agent、Host Header、SNI、追踪有效状态码、地区码过滤、调试抓包开关和目标等。旧配置中的下载数量字段仍保留兼容，但不再限制文件测速数量。
