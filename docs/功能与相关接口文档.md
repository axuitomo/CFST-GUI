...
本文档基于当前仓库源码整理 CFST-GUI 的功能、运行链路和接口边界。当前项目是一个基于 Wails v3.0.0-beta.16 + Vue 的桌面端 Cloudflare/CDN IP 测速工具，后端 Go 目标版本为 1.27.0。
...
| Wails 生成代码 | `frontend/bindings` 可能需要通过 `wails3 generate bindings` 生成 生成 |
