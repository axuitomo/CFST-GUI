...
| 配置 Cloudflare DNS 推送 API Token 最小权限和排错 | [Cloudflare API Token 权限设置教程](./cloudflare-api-token.md) |
...
`docs/cloudflare-api-token.md` 说明 Cloudflare DNS 推送需要的 API Token 最小权限、Zone ID 获取、应用内填写位置、常见报错和安全边界。
