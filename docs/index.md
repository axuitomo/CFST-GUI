...
| 查看 v1.7.8 变更摘要、验证命令和发行资产 | [v1.7.8 发布说明](./release-notes/v1.7.8.md) |
...
`docs/release-notes/v1.7.8.md` 说明 v1.7.8 的随机初始化清理、WebUI 目录弹窗安全改造、GitHub 导出筛选统一、探测/工作流异常恢复、启动容错和发行资产。
