...
| 查看 v1.7.7 变更摘要、验证命令和发行资产 | [v1.7.7 发布说明](./release-notes/v1.7.7.md) |
...
`docs/release-notes/v1.7.7.md` 说明 v1.7.7 的工作流 runtime 拆分、禁用 target 跳过、旧 action alias 兼容、输入源自动保存、WorkflowView 收敛、侧边栏偏好和发行资产。
