    ...
    <div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        ...
        <summary class="settings-summary flex cursor-pointer items-center justify-between gap-3 bg-slate-50/70 px-4 py-3 transition hover:bg-slate-100/70 sm:px-6 sm:py-4 lg:px-5 lg:py-3">
          <div class="min-w-0">
            ...
            <p class="mt-1 hidden truncate text-xs text-slate-500 sm:block">
              当前版本 {{ appInfo.current_version || "1.0" }} · {{ appInfo.platform || "desktop" }}
            </p>
          </div>
        ...
        <div class="space-y-4 border-t border-slate-100 p-4 sm:p-6 lg:p-5">
          ...
          <div v-if="profiles.items.length > 0" class="space-y-2">
            <div
              ...
              :key="profile.id"
              class="grid gap-3 rounded-xl border border-slate-200 bg-slate-50 px-3 py-3 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center"
            >
              <div class="min-w-0">
      ...
      >
        ...
        <div class="grid gap-4 border-t border-slate-100 p-4 sm:p-6 md:grid-cols-2 lg:p-5">
          ...
          <div class="flex items-center rounded-xl border border-slate-200 bg-slate-50/70 px-4 py-3 text-sm text-slate-500">
